...
class BallTracker:
    ...
    # supress wrong detections for the bball
    def remove_wrong_detections(self, ball_positions):
        ...
        for i in range(len(ball_positions)):
            ...
            last_good_box = ball_positions[i].get(1,{}).get("bbox", [])
            frame_gap = i - last_good_frame_index
            adjusted_max_distance = maximum_allowed_distance * frame_gap # calculate the distance between last good bbox and the current position
